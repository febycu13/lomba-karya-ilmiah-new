...
<head>
    ...
    <!-- Favicons -->
    <link href="storage/assets/img/favicon.ico" rel="icon">
...
<body class="index-page">
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
                ...
                <img src="storage/assets/img/logo.webp" alt="">
                    ...
                    <div class="col-lg-5" data-aos="zoom-out">
                        <div class="visual-content">
                            <div class="fluid-shape">
                                <img src="storage/assets/img/abstract/abstract-1.webp" alt="Abstract Fluid Shape"
                                    class="fluid-img">
                            </div>
                ...
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
                        <div class="about-image position-relative">
                            <img src="storage/assets/img/about/about-portrait-1.webp"
                                class="img-fluid rounded-4 shadow-sm" alt="About Image" loading="lazy">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <div class="client-info d-flex align-items-center mt-4">
                                                <img src="storage/assets/img/person/person-f-1.webp" class="client-img"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <p>"Collaborating with their team was a revelation. Their innovative
                                                ...
                                                speed."</p>
                                            <div class="client-info d-flex align-items-center mt-4">
                                                <img src="storage/assets/img/person/person-m-1.webp" class="client-img"
                                                    alt="Client" loading="lazy">
                                                <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <p>"The depth of knowledge and unwavering dedication they bring to every
                                                ...
                                                expansion."</p>
                                            <div class="client-info d-flex align-items-center mt-4">
                                                <img src="storage/assets/img/person/person-f-2.webp" class="client-img"
                                                    alt="Client" loading="lazy">
                                                <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="testimonial-item">
                                            ...
                                            <p>"Their dedication to delivering superior solutions and their meticulous
                                                ...
                                                trajectory."</p>
                                            <div class="client-info d-flex align-items-center mt-4">
                                                <img src="storage/assets/img/person/person-f-3.webp" class="client-img"
                                                    alt="Client" loading="lazy">
                                                <div>
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
                    ...
                    <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
                        <img src="storage/assets/img/misc/misc-1.webp" alt="Digital Platform"
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="profile d-flex align-items-center">
                                            <img src="storage/assets/img/person/person-m-7.webp" class="profile-img"
                                                alt="">
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="featured-img-wrapper">
                                            <img src="storage/assets/img/person/person-m-7.webp" class="featured-img"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="testimonial-item">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="profile d-flex align-items-center">
                                            <img src="storage/assets/img/person/person-f-8.webp" class="profile-img"
                                                alt="">
                                            <div class="profile-info">
                                                <h3>Sara Wilsson</h3>
                                                <span>Designer</span>
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="featured-img-wrapper">
                                            <img src="storage/assets/img/person/person-f-8.webp" class="featured-img"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="testimonial-item">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="profile d-flex align-items-center">
                                            <img src="storage/assets/img/person/person-m-9.webp" class="profile-img"
                                                alt="">
                                            <div class="profile-info">
                                                <h3>Matt Brandon</h3>
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="featured-img-wrapper">
                                            <img src="storage/assets/img/person/person-m-9.webp" class="featured-img"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="testimonial-item">
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="profile d-flex align-items-center">
                                            <img src="storage/assets/img/person/person-f-10.webp" class="profile-img"
                                                alt="">
                                            <div class="profile-info">
                                                <h3>Jena Karlis</h3>
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="featured-img-wrapper">
                                            <img src="storage/assets/img/person/person-f-10.webp" class="featured-img"
                                                alt="">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
                    ...
                    <div class="row g-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-1.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-1.webp"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-10.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-10.webp"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-photography">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-7.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-7.webp"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-marketing">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-4.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-4.webp"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-ui">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-2.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            <div class="entry-meta">UI/UX Design</div>
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-2.webp"
                                                    class="glightbox" data-gallery="portfolio-gallery-ui"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-development">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-11.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            <div class="entry-meta">Development</div>
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-11.webp"
                                                    class="glightbox" data-gallery="portfolio-gallery-development"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-photography">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-8.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            <div class="entry-meta">Photography</div>
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-8.webp"
                                                    class="glightbox" data-gallery="portfolio-gallery-photography"
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-marketing">
                            <article class="portfolio-entry">
                                <figure class="entry-image">
                                    <img src="storage/assets/img/portfolio/portfolio-5.webp" class="img-fluid" alt=""
                                        loading="lazy">
                                    <div class="entry-overlay">
                                        <div class="overlay-content">
                                            <div class="entry-meta">Marketing</div>
                                            ...
                                            <div class="entry-links">
                                                <a href="storage/assets/img/portfolio/portfolio-5.webp"
                                                    class="glightbox" data-gallery="portfolio-gallery-marketing"
            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="storage/assets/img/person/person-m-7.webp" class="img-fluid" alt=""
                                    loading="lazy">
                            </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="storage/assets/img/person/person-f-8.webp" class="img-fluid" alt=""
                                    loading="lazy">
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="storage/assets/img/person/person-m-6.webp" class="img-fluid" alt=""
                                    loading="lazy">
                            </div>
                            <div class="member-info flex-grow-1">
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="storage/assets/img/person/person-f-4.webp" class="img-fluid" alt=""
                                    loading="lazy">
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Amanda Jepson</h4>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="storage/assets/img/person/person-m-12.webp" class="img-fluid" alt=""
                                    loading="lazy">
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Brian Doe</h4>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
                        <div class="team-member d-flex">
                            <div class="member-img">
                                <img src="storage/assets/img/person/person-f-9.webp" class="img-fluid" alt=""
                                    loading="lazy">
                            </div>
                            <div class="member-info flex-grow-1">
                                <h4>Josepha Palas</h4>
    ...
    <script src="storage/assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
